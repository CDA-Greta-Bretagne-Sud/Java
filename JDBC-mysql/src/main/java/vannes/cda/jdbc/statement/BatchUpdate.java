package vannes.cda.jdbc.statement;
...
public class BatchUpdate {
    ...
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(
            ...
            // insert
            statement.addBatch(generateInsert("plamy", new BigDecimal(1000)));

            // insert
            statement.addBatch(generateInsert("valerie", new BigDecimal(2000)));

            // update
            statement.addBatch(updateSalaryByName("plamy", new BigDecimal(888)));
